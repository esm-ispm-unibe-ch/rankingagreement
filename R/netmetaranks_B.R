...
### plot rankograms 
  ...
  # cbind(SUCRA, netrank(nma1)$Pscore.random) ## check it is the same as p-score from netrank
    ...
    ### calculate median rank
      ...
      return(cbind("pBV"=p.rank_1st, "pBV ranks"=p1st_rankings, SUCRA, SUCRA_ranks, "P-score"=netrank(nma, small.values = "bad")$Pscore.random, Pscore_ranks, "Mean rank"=mean.rank, "Median rank"=med.rank))
